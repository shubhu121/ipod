...
export default function V4Page() {
  ...
  const handleMenuNav = useCallback((dir: "up" | "down") => {
    playTick();
    if (screenView === "menu") setMenuIndex((p) => dir === "up" ? (p - 1 + PLAYLIST.length) % PLAYLIST.length : (p + 1) % PLAYLIST.length);
  }, [playTick, screenView]);

  const press = (id: string) => { setActiveBtn(id); setTimeout(() => setActiveBtn(null), 120); };
  ...
  return (
    <main className="relative flex-1 flex flex-col items-center justify-center min-h-screen overflow-hidden select-none">
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(255,107,53,0.3) 0%, transparent 70%)", top: "5%", left: "-12%", animation: "orb-drift-1 22s ease-in-out infinite" }}
      />
      <div
        className="pointer-events-none fixed w-[450px] h-[450px] rounded-full opacity-[0.02]"
        style={{ background: "radial-gradient(circle, rgba(120,160,255,0.2) 0%, transparent 70%)", bottom: "0%", right: "-10%", animation: "orb-drift-2 28s ease-in-out infinite" }}
      />
      ...
      <div style={{ animation: "float 6s ease-in-out infinite" }}>
        <div
          ...
          style={{
            ...
            boxShadow: "0 1px 0.5px rgba(255,255,255,0.1) inset, 0 1px 2px rgba(255,255,255,0.18) inset, 0 10px 10px -9px rgba(0,0,0,0.7), 0 20px 20px -14px rgba(0,0,0,0.6), 0 0px 6px 0px rgba(0,0,0,0.6)",
        ...
        >
          ...
          <div
            ...
            style={{
              borderRadius: "12px",
              background: "#080808",
              boxShadow: "0 0.5px 0 rgba(255,255,255,0.2), 0 2px 6px rgba(0,0,0,0.9) inset",
              padding: "2px",
            }}
          >
            <div
              ...
              {screenView === "player" ? (
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-3">
                    <button onClick={handleMenuToggle} className="text-[9px] text-gray-500 hover:text-gray-300 transition-colors cursor-pointer tracking-wider">☰ MENU</button>
                  ...
                  <div className="mb-0.5">
                    ...
                    <div className="flex justify-between mt-1 px-0.5">
                      <span className="text-[8px] text-gray-600 font-mono tabular-nums">{fmt(elapsed)}</span>
                      <span className="text-[8px] text-gray-600 font-mono tabular-nums">-{fmt(duration - elapsed)}</span>
                    </div>
                  </div>
                </div>
              ) : (
                <div className="relative z-10">
                  ...
                  <div className="space-y-[1px] max-h-[155px] overflow-y-auto pr-1">
                    {PLAYLIST.map((item, idx) => (
                      <button
                        key={item.id}
                        onClick={() => handleMenuSelect(idx)}
                        className="w-full text-left px-2 py-[5px] rounded-lg transition-all duration-100 cursor-pointer"
                        style={{
          ...
          <div className="flex justify-center">
            <div
              ...
              style={{
                ...
                borderRadius: "50%",
                background: "#0e0e0e",
                boxShadow: "0 0.5px 0 rgba(255,255,255,0.15), 0 2px 6px rgba(0,0,0,0.9) inset",
              }}
            >
              <div
                ...
                style={{
                  inset: "3px",
                  borderRadius: "50%",
                  background: "radial-gradient(circle at 50% 45%, #1a1a1a, #141414 40%, #111 70%, #0f0f0f 100%)",
                }}
              />
              ...
              <button
                id="v4-menu"
                onClick={() => { press("menu"); handleMenuToggle(); }}
                className="absolute z-10 cursor-pointer left-1/2 -translate-x-1/2"
                style={{ top: "18px", transition: "transform 50ms ease", transform: activeBtn === "menu" ? "scale(0.9)" : "scale(1)" }}
              >
                <span
                  className="text-[10px] font-medium uppercase"
                  style={{ letterSpacing: "0.22em", color: activeBtn === "menu" ? "rgba(255,255,255,0.45)" : "rgba(255,255,255,0.18)" }}
                >
                  MENU
                </span>
              </button>
              ...
              <button
                id="v4-prev"
                onClick={() => { press("prev"); screenView === "menu" ? handleMenuNav("up") : handlePrev(); }}
                className="absolute z-10 cursor-pointer top-1/2 -translate-y-1/2"
                style={{ left: "20px", transition: "transform 50ms ease", transform: activeBtn === "prev" ? "scale(0.85)" : "scale(1)" }}
              >
                <svg width="13" height="13" viewBox="0 0 24 24" style={{ fill: activeBtn === "prev" ? "rgba(255,255,255,0.45)" : "rgba(255,255,255,0.18)" }}>
              ...
              <button
                id="v4-next"
                onClick={() => { press("next"); screenView === "menu" ? handleMenuNav("down") : handleNext(); }}
                className="absolute z-10 cursor-pointer top-1/2 -translate-y-1/2"
                style={{ right: "20px", transition: "transform 50ms ease", transform: activeBtn === "next" ? "scale(0.85)" : "scale(1)" }}
              >
                <svg width="13" height="13" viewBox="0 0 24 24" style={{ fill: activeBtn === "next" ? "rgba(255,255,255,0.45)" : "rgba(255,255,255,0.18)" }}>
              ...
              <button
                id="v4-play"
                onClick={() => { press("play"); screenView === "menu" ? handleMenuSelect(menuIndex) : handlePlayPause(); }}
                className="absolute z-10 cursor-pointer left-1/2 -translate-x-1/2"
                style={{ bottom: "18px", transition: "transform 50ms ease", transform: activeBtn === "play" ? "scale(0.85)" : "scale(1)" }}
              >
                {isPlaying ? (
                  <svg width="12" height="12" viewBox="0 0 24 24" style={{ fill: activeBtn === "play" ? "rgba(255,255,255,0.45)" : "rgba(255,255,255,0.18)" }}>
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 0.5px 0 rgba(255,255,255,0.03), 0 -0.5px 0 rgba(0,0,0,0.4)",
                }}
              />
              ...
              <button
                ...
                onClick={() => {
                  press("select");
                  playClick();
                  screenView === "menu" ? handleMenuSelect(menuIndex) : setShowPlaylist(!showPlaylist);
                }}
                ...
                style={{
                  ...
                  height: "76px",
                  borderRadius: "50%",
                  background: "linear-gradient(180deg, #1c1c1c 0%, #171717 50%, #141414 100%)",
                  boxShadow: activeBtn === "select"
                    ? "0 1px 4px rgba(0,0,0,0.6) inset, 0 0 0 1px rgba(0,0,0,0.3)"
                    : "0 1px 0.5px rgba(255,255,255,0.06) inset, 0 1px 1px rgba(255,255,255,0.03) inset, 0 3px 8px rgba(0,0,0,0.35), 0 0 0 1px rgba(0,0,0,0.2)",
          ...
          <div className="flex justify-center mt-3">
            <div
              className="w-[46px] h-[4px] rounded-full"
              style={{
                background: "#0a0a0a",
        ...
        <div
          ...
          style={{ width: "180px", height: "25px", background: "radial-gradient(ellipse, rgba(255,107,53,0.12) 0%, transparent 70%)", filter: "blur(10px)", opacity: 0.4 }}
        />
      </div>
            ...
            <div className="space-y-[2px]">
              {PLAYLIST.map((item, idx) => (
                <button
                  ...
                  style={{ background: currentIndex === idx ? "rgba(255,107,53,0.08)" : "transparent", animation: `slide-up 0.2s ease-out ${idx * 0.03}s both` }}
                >
